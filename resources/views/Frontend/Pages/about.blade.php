...
<div class="page-wraper">
	<div class="page-content">
		...
		<section class="content-inner bg-light overflow-hidden">
			<div class="container">
				<div class="row">
						...
						<div class="row g-xl-4 g-md-4 g-3 align-items-end">
							<div class="col-xl-8 col-lg-8 col-sm-8 col-8 wow fadeInUp" data-wow-delay="0.4s">
								<div class="about-thumb shape-03">
									<img src="{{url('Frontend/images/about/pic3.jpg')}}" alt="">
								</div>
							</div>
							<div class="col-xl-4 col-lg-4 col-sm-4 col-4 wow fadeInUp" data-wow-delay="0.5s">
								<div class="about-thumb shape-04">
									<img src="{{url('Frontend/images/about/pic4.jpg')}}" alt="">
								</div>
							</div>
							<div class="accordion dz-accordion accordion-sm wow fadeInUp bg-light" data-wow-delay="0.3s" id="accordionFaq">
								<div class="accordion-item">
									...
									<div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionFaq">
										<div class="accordion-body">
											<p class="m-b0">If your order has not yet shipped, you can contact us to change your shipping address. If your order has already shipped, we may not be able to change</p>
										</div>
									</div>
								</div>
								<div class="accordion-item">
							...
							<div class="about-sale mt-3">
								<div class="row">
									...
									<div class="col-lg-4 col-md-6 col-sm-6 col-6 wow fadeInUp" data-wow-delay="0.5s">
										<div class="about-content">
					...
					<div class="col-lg-6">
						<div class="section-head style-3 wow fadeInUp m-md-r100" data-wow-delay="0.1s">
							<h3 class="title">The personality and style you want stars our pet care show!</h3>
							<p class="m-b30">At Untouch, we are on a mission to redefine fashion by blending style, quality, and individuality into every garment we offer. We believe that what you wear is an extension of your unique personality, and it and aspirations.</p>		
						</div>
						<div class="author-bx-detail m-b35 wow fadeInUp" data-wow-delay="0.2s">
						...
						<div class="about-thumb shape-05">
							<img src="{{url('Frontend/images/about/pic5.jpg')}}" alt="">
						</div>
					</div>	
				</div>
			</div>
		...
		<!-- About Start-->
		<section class="overflow-hidden back-main">
			<div class="container">
				<div class="row about-style2 align-items-center ">
					<div class="col-lg-6 m-b30 order-1 order-lg-0 align-self-end">
						<div class="position-relative">
							<div class="about-thumb wow fadeInUp" data-wow-delay="0.1s">
								<img src="images/shop/about-dog.png" alt="">
					...
					<div class="col-lg-6 m-b30 aos-item wow fadeInUp" data-wow-delay="0.3s">
						...
						<div class="swiper swiper-five-2 bg-white">
					...
					<img src="images/line-shape.png" class="line" alt="round">
				</div>
			</div>
		</section>
		<!-- About End -->
			...
			<div class="container">
				<div class="section-inner p-t10">
					...
					<div class="row companies-inner">
						<div class="col-md-3 col-sm-4 col-6 p-lg-b30 p-b30 wow fadeInUp" data-wow-delay="0.1s">
						...
						<div class="col-md-3 col-sm-4 col-6 p-lg-b30 p-b30 wow fadeInUp" data-wow-delay="0.2s">
							<a href="javascript:void(0);" class="companies-wrapper">
								<div class="companies-media">
						...
						<div class="col-md-3 col-sm-4 col-6 p-lg-b30 p-b30 wow fadeInUp" data-wow-delay="0.3s">
							<a href="javascript:void(0);" class="companies-wrapper">
								<div class="companies-media">
						...
						<div class="col-md-3 col-sm-4 col-6 p-lg-b30 p-b30 wow fadeInUp" data-wow-delay="0.4s">
							<a href="javascript:void(0);" class="companies-wrapper">
								<div class="companies-media">
						...
						<div class="col-md-3 col-sm-4 col-6 p-lg-b30 p-b30 wow fadeInUp" data-wow-delay="0.5s">
							<a href="javascript:void(0);" class="companies-wrapper">
								<div class="companies-media">
						...
						<div class="col-md-3 col-sm-4 col-6 p-lg-b30 p-b30 wow fadeInUp" data-wow-delay="0.6s">
							<a href="javascript:void(0);" class="companies-wrapper">
								<div class="companies-media">
						...
						<div class="col-md-3 col-sm-4 col-6 p-lg-b30 p-b30 wow fadeInUp" data-wow-delay="0.7s">
							<a href="javascript:void(0);" class="companies-wrapper">
								<div class="companies-media">
						...
						<div class="col-md-3 col-sm-4 col-6 p-lg-b30 p-b30 wow fadeInUp" data-wow-delay="0.8s">
							<a href="javascript:void(0);" class="companies-wrapper">
								<div class="companies-media">
