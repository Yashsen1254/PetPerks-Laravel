					...
					<div class="row">
						<div class="col-lg-6">
							<div class="contact-info style-1 text-start">
								<h2 class="title wow fadeInUp m-b25" data-wow-delay="0.1s">DISCOVER US</h2>
								<p class="text wow fadeInUp" data-wow-delay="0.2s"><span class="text-decoration-underline"><a href="https://petperks.dexignzone.com/xhtml/page-error-404.html">PetPerks is here to help you;</a></span> <br> Our experts are available to answer any questions you might have. We’ve got the answers..</p>
						...
						<div class="col-lg-6">
							<div class="contact-area1 style-1 m-r20 m-md-r0 wow fadeInUp" data-wow-delay="0.5s">
								<form class="dz-form dzForm" method="POST" action="https://petperks.dexignzone.com/xhtml/script/contact_smtp.php">
									<input type="hidden" class="form-control" name="dzToDo" value="Contact">
									<input type="hidden" class="form-control" name="reCaptchaEnable" value="0">
									<div class="dzFormMsg"></div>
									<label class="form-label title">Your Name</label>
									...
									<label class="form-label title">Massage</label>
									...
									<div>
										<button name="submit" type="submit" value="submit" class="btn w-100 btnhover btn-secondary">SUBMIT</button>
									</div>
								</form>
							</div>
						</div>
