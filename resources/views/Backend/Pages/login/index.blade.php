...
<!-- Mirrored from admin.pixelstrap.net/admiro/template/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Jan 2025 18:10:12 GMT -->
...
<body>
    <div class="container-fluid p-0">
                ...
                <div class="login-card login-dark">
                    <div>
                        <div class="login-main"> 
                            <form class="theme-form" action="{{url('/admin/login/store')}}" method="POST">
                                @csrf
                                <h2 class="text-center">Sign in to account</h2>
                                <p class="text-center">Enter your email &amp; password to login</p>
                                <div class="form-group">
                                    <label class="col-form-label">Email Address</label>
                                    <input class="form-control" type="email" placeholder="Test@gmail.com" id="Email" name="Email">
                                </div>
                                <div class="form-group">
        ...
        <script src="{{url('Backend/js/vendors/jquery/jquery.min.js')}}"></script>
        <script src="{{url('Backend/js/vendors/bootstrap/dist/js/bootstrap.bundle.min.js')}}" defer=""></script>
        <script src="{{url('Backend/js/vendors/bootstrap/dist/js/popper.min.js')}}" defer=""></script>
        <script src="{{url('Backend/js/vendors/font-awesome/fontawesome-min.js')}}"></script>
        <script src="{{url('Backend/js/password.js')}}"></script>
